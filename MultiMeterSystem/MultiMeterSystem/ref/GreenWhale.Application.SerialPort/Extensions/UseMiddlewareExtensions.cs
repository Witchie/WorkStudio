    ...
    public static class UseMiddlewareExtensions
    {
        ...
        public static IApplicationBuilder UseMiddleware(this IApplicationBuilder app, Type middleware, params object[] args)
        {
            if (typeof(IMiddleware).GetTypeInfo().IsAssignableFrom(middleware.GetTypeInfo()))
            {
                ...
                if (args.Length > 0)
                {
                    throw new NotSupportedException(typeof(IMiddleware).Name);
                }
            ...
            return app.Use(next =>
            {
                ...
                {
                    throw new InvalidOperationException("FormatException_UseMiddleMutlipleInvokes(InvokeMethodName, InvokeAsyncMethodName)");
                }
                ...
                if (parameters.Length == 0 || parameters[0].ParameterType != typeof(SerialPortContext))
                {
        ...
        private static Func<T, ISerialPortContext, IServiceProvider, Task> Compile<T>(MethodInfo methodInfo, ParameterInfo[] parameters)
        {
            ...
            var httpContextArg = Expression.Parameter(typeof(SerialPortContext), "httpContext");
            ...
            var lambda = Expression.Lambda<Func<T, ISerialPortContext, IServiceProvider, Task>>(body, instanceArg, httpContextArg, providerArg);
